...
GRADING_ACCURACY_MAX_THRESHOLD = os.environ.get("GRADING_ACCURACY_MAX_THRESHOLD", 100)
GRADING_ACCURACY_MIN_THRESHOLD = os.environ.get("GRADING_ACCURACY_MIN_THRESHOLD", 0)
